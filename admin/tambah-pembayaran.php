...
<input readonly name="id_spp" value="<?= $data['id_spp'] ?>" type="hidden"   class="form-control" required>
    ...
    <div class="form-group mb-2">
        ...
        <input disabled value="<?= $data['nama'] ?>"  class="form-control" required>
    </div>
    <div class="form-group mb-2">
        <label> Tanggal Bayar </label>
        <input type="date" name="tgl_bayar" class="form-control" required value="<?= date('Y-m-d'); ?>">
    </div>
    <div class="form-group mb-2">
