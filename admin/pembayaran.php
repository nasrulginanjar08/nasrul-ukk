    ...
    <?php
        ...
        foreach ($query as $data ){ 
            ...
            <tr>
                ...
                <td><?php echo number_format($sudah_bayar,2,',',',') ;?></td>
                <td><?php echo number_format($kekurangan,2,',',',') ;?></td>
                <td>
                    <?php 
                    if($kekurangan==0){
                        echo"<span class='badge text-bg-danger'> Sudah Lunas </span>";
                    }else{ ?>
                        <a href="?url=tambah-pembayaran&nisn=<?= $data['nisn'] ?>&kekurangan=<?= $kekurangan ?>" class="btn btn-danger"> Pilih & Bayar </a>               
                   <?php  } ?>
                </td>
                <td>
                    <a href="?url=history-pembayaran&nisn=<?= $data['nisn'] ?>" class='btn btn-info'> Lihat History </a>
                </td>
            </tr>
